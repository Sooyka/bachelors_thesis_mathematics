...
from Hopf algebra $\mathcal{H}$ turns out to be one discribed above. (Note, that $\mathcal{H} = \displaystyle\bigoplus^{\infty}_{i = 0} \mathcal{H}_i$ is isomorphic as a linear space 
