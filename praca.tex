...
\end{definition}
\begin{definition}
A \textbf{graded bialgebra} is vector space 
...
degrees $i$, $j$, their product has degree $i + j$). 
...
counit is then  
We can now check, that $P$ with that structure is a graded, connected Hopf algebra.
\todo{BAM! DO ROBOTY!}
