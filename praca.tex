...
First we will do this with inverse riffle shuffle, th forward riffle shuffle will then apear in natural way. \\
...
a sum of possible arregements of stack with coresponding probabilities. Ta- daaaam! \\
