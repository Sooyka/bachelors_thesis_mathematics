...
\end{equation*} 
which is the sum of all possible divisions of $s$ into its prefix and sufix. \\
...
stacks together with the same probability of every possible interlace of to stacks.
